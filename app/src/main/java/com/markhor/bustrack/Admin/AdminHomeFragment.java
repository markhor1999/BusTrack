...
public class AdminHomeFragment extends Fragment implements OnMapReadyCallback,
    ...
    private void getAllTheDrivers() {
        CollectionReference driverRef = mRootRef.collection("Drivers");
    ...
    /*private void addAllMarkers(double latitude, double longitude) {
        Log.d(TAG, "setCameraView: " + latitude + longitude);
    ...
    private void addMapMarkers(BusLocations busLocations) {
        if (mGoogleMap != null) {
            ...
            animateTheCameraToUni(32.0736519, 72.6781505);
